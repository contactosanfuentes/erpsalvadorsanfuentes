// Estrategia educativa pionera: toda Empresa vive un ciclo de fases.
const FASES_EMPRESA=['Idear','Elegir','Planificar','Realizar','Evaluar','Celebrar'];
// ══════════ MODAL PROYECTO ══════════
function abrirModalProyecto(editIdx){
mpResponsables={};mpParticipantes=[];mpEvidencias=[];
document.getElementById('mp-edit-id').value='';document.getElementById('mp-nombre').value='';document.getElementById('mp-objetivo').value='';if(document.getElementById('mp-fase'))document.getElementById('mp-fase').value='Idear';
...
document.getElementById('mp-objetivo').value=p.objetivo||'';if(document.getElementById('mp-fase'))document.getElementById('mp-fase').value=p.fase||'Idear';
