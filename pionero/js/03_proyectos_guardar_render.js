...
await sb.from('configuracion_presupuesto').insert({evento_id:ev.id,participantes:mpParticipantes.length,staff:Object.keys(mpResponsables).length,dias,nota:'Desde portal pionero'});
