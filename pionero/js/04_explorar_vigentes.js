...
function renderTarjetaVigentePV(p) {
    ...
    if ((p.evidencias||[]).length) {
        ...
        html += '<p class="text-[0.62rem] font-extrabold text-gray-400 uppercase tracking-wider mb-2"><i class="fas fa-paperclip mr-1"></i> Soportes dla empresa (' + p.evidencias.length + ')</p>';
